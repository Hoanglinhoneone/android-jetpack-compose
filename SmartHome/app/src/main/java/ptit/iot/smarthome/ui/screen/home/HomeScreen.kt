...
//                    .align(Alignment.CenterVertically),
                    ...
                    Text(
                        text = if (uiState.isListening) stringResource(R.string.on) else stringResource(R.string.off),
                        color = MaterialTheme.colorScheme.onSurface,
                        style = MaterialTheme.typography.titleMedium,
...
//                    .align(Alignment.CenterVertically),
                    ...
                    Text(
                        text = if (uiState.isLightOn) stringResource(R.string.on) else stringResource(R.string.off),
                        style = MaterialTheme.typography.titleMedium,
                        color = MaterialTheme.colorScheme.onSurface,
                        modifier = Modifier.align(Alignment.CenterHorizontally)
                    )
